...
function TableHeader({ className, ...props }: React.ComponentProps<"thead">) {
  return (
    <thead
      ...
      className={cn("[&_tr]:border-b [&_tr]:bg-surface-subtle [&_tr:hover]:bg-surface-subtle", className)}
      {...props}
    />
  )
}
...
function TableRow({ className, ...props }: React.ComponentProps<"tr">) {
  return (
    <tr
      data-slot="table-row"
      className={cn(
        "border-b border-border transition-colors hover:bg-hover-surface has-aria-expanded:bg-selected-surface data-[state=selected]:bg-selected-surface",
        className
      )}
      {...props}
    />
